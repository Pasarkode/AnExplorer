...
import dev.dworks.apps.moexplorer.network.NetworkFile;

import static dev.dworks.apps.moexplorer.misc.MimeTypes.BASIC_MIME_TYPE;
...
import static dev.dworks.apps.moexplorer.provider.ExplorerProvider.ConnectionColumns;
