...
import static dev.dworks.apps.moexplorer.R.id.action_close;
import static dev.dworks.apps.moexplorer.R.id.action_feedback;
import static dev.dworks.apps.moexplorer.R.id.action_rate;
