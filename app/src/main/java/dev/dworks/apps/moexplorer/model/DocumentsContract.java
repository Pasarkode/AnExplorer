...
import dev.dworks.apps.moexplorer.misc.OsCompat;
import dev.dworks.apps.moexplorer.misc.Utils;
import dev.dworks.apps.moexplorer.provider.DocumentsProvider;
import dev.dworks.apps.moexplorer.provider.UsbStorageProvider;

import static dev.dworks.apps.moexplorer.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     * {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link dev.dworks.apps.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
