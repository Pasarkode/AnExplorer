...
import dev.amoeba.moexplorer.misc.OsCompat;
import dev.amoeba.moexplorer.misc.Utils;
import dev.amoeba.moexplorer.provider.DocumentsProvider;
import dev.amoeba.moexplorer.provider.UsbStorageProvider;

import static dev.amoeba.moexplorer.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     * {@link dev.amoeba.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link dev.amoeba.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link dev.amoeba.moexplorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link dev.amoeba.moexplorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link dev.amoeba.moexplorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link dev.amoeba.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link dev.amoeba.moexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
