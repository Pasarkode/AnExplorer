...
package dev.dworks.apps.moexplorer.provider;
...
import dev.dworks.apps.moexplorer.libcore.util.Objects;
...
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.buildDocumentUri;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.buildTreeDocumentUri;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.getDocumentId;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.getRootId;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.getSearchDocumentsQuery;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.getTreeDocumentId;
import static dev.dworks.apps.moexplorer.model.DocumentsContract.isTreeUri;
