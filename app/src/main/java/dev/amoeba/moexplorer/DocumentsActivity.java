...
import dev.amoeba.moexplorer.archive.DocumentArchiveHelper;
import dev.amoeba.moexplorer.fragment.ConnectionsFragment;
import dev.amoeba.moexplorer.fragment.CreateDirectoryFragment;
import dev.amoeba.moexplorer.fragment.CreateFileFragment;
import dev.amoeba.moexplorer.fragment.DirectoryFragment;
import dev.amoeba.moexplorer.fragment.HomeFragment;
import dev.amoeba.moexplorer.fragment.MoveFragment;
import dev.amoeba.moexplorer.fragment.PickFragment;
import dev.amoeba.moexplorer.fragment.RecentsCreateFragment;
import dev.amoeba.moexplorer.fragment.RootsFragment;
import dev.amoeba.moexplorer.fragment.SaveFragment;
import dev.amoeba.moexplorer.fragment.ServerFragment;
import dev.amoeba.moexplorer.libcore.io.IoUtils;
import dev.amoeba.moexplorer.misc.AnalyticsManager;
import dev.amoeba.moexplorer.misc.AppRate;
import dev.amoeba.moexplorer.misc.AsyncTask;
import dev.amoeba.moexplorer.misc.ConnectionUtils;
import dev.amoeba.moexplorer.misc.ContentProviderClientCompat;
import dev.amoeba.moexplorer.misc.CrashReportingManager;
import dev.amoeba.moexplorer.misc.IntentUtils;
import dev.amoeba.moexplorer.misc.MimePredicate;
import dev.amoeba.moexplorer.misc.PermissionUtil;
import dev.amoeba.moexplorer.misc.PinViewHelper;
import dev.amoeba.moexplorer.misc.PinViewHelper.PINDialogFragment;
import dev.amoeba.moexplorer.misc.ProviderExecutor;
import dev.amoeba.moexplorer.misc.RootsCache;
import dev.amoeba.moexplorer.misc.SAFManager;
import dev.amoeba.moexplorer.misc.SystemBarTintManager;
import dev.amoeba.moexplorer.misc.Utils;
import dev.amoeba.moexplorer.model.DocumentInfo;
import dev.amoeba.moexplorer.model.DocumentStack;
import dev.amoeba.moexplorer.model.DocumentsContract;
import dev.amoeba.moexplorer.model.DocumentsContract.Root;
import dev.amoeba.moexplorer.model.DurableUtils;
import dev.amoeba.moexplorer.model.RootInfo;
import dev.amoeba.moexplorer.network.NetworkConnection;
import dev.amoeba.moexplorer.provider.ExternalStorageProvider;
import dev.amoeba.moexplorer.provider.RecentsProvider;
import dev.amoeba.moexplorer.provider.RecentsProvider.RecentColumns;
import dev.amoeba.moexplorer.provider.RecentsProvider.ResumeColumns;
import dev.amoeba.moexplorer.setting.SettingsActivity;
import dev.amoeba.moexplorer.ui.DirectoryContainerView;
import dev.amoeba.moexplorer.ui.FloatingActionsMenu;
import dev.amoeba.moexplorer.ui.fabs.SimpleMenuListenerAdapter;

import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_BROWSE;
import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_CREATE;
import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_GET_CONTENT;
import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_MANAGE;
import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_OPEN;
import static dev.amoeba.moexplorer.BaseActivity.State.ACTION_OPEN_TREE;
import static dev.amoeba.moexplorer.BaseActivity.State.MODE_GRID;
import static dev.amoeba.moexplorer.BaseActivity.State.MODE_LIST;
import static dev.amoeba.moexplorer.DocumentsApplication.isTelevision;
import static dev.amoeba.moexplorer.fragment.DirectoryFragment.ANIM_DOWN;
import static dev.amoeba.moexplorer.fragment.DirectoryFragment.ANIM_NONE;
import static dev.amoeba.moexplorer.fragment.DirectoryFragment.ANIM_SIDE;
import static dev.amoeba.moexplorer.fragment.DirectoryFragment.ANIM_UP;
import static dev.amoeba.moexplorer.misc.AnalyticsManager.FILE_COUNT;
import static dev.amoeba.moexplorer.misc.AnalyticsManager.FILE_MOVE;
import static dev.amoeba.moexplorer.misc.AnalyticsManager.FILE_TYPE;
import static dev.amoeba.moexplorer.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static dev.amoeba.moexplorer.misc.Utils.EXTRA_ROOT;
import static dev.amoeba.moexplorer.provider.ExternalStorageProvider.isDownloadAuthority;
