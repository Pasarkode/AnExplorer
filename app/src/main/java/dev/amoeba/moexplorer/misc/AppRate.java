...
import static dev.amoeba.moexplorer.R.id.action_close;
import static dev.amoeba.moexplorer.R.id.action_feedback;
import static dev.amoeba.moexplorer.R.id.action_rate;
