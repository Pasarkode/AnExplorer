...
import dev.amoeba.moexplorer.usb.UsbUtils;

import static dev.amoeba.moexplorer.DocumentsApplication.isTelevision;
import static dev.amoeba.moexplorer.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "dev.amoeba.moexplorer.action.USB_PERMISSION";
