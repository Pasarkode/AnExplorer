...
package dev.dworks.apps.moexplorer;
...
import dev.dworks.apps.moexplorer.archive.DocumentArchiveHelper;
import dev.dworks.apps.moexplorer.fragment.ConnectionsFragment;
import dev.dworks.apps.moexplorer.fragment.CreateDirectoryFragment;
import dev.dworks.apps.moexplorer.fragment.CreateFileFragment;
import dev.dworks.apps.moexplorer.fragment.DirectoryFragment;
import dev.dworks.apps.moexplorer.fragment.HomeFragment;
import dev.dworks.apps.moexplorer.fragment.MoveFragment;
import dev.dworks.apps.moexplorer.fragment.PickFragment;
import dev.dworks.apps.moexplorer.fragment.RecentsCreateFragment;
import dev.dworks.apps.moexplorer.fragment.RootsFragment;
import dev.dworks.apps.moexplorer.fragment.SaveFragment;
import dev.dworks.apps.moexplorer.fragment.ServerFragment;
import dev.dworks.apps.moexplorer.libcore.io.IoUtils;
import dev.dworks.apps.moexplorer.misc.AnalyticsManager;
import dev.dworks.apps.moexplorer.misc.AppRate;
import dev.dworks.apps.moexplorer.misc.AsyncTask;
import dev.dworks.apps.moexplorer.misc.ConnectionUtils;
import dev.dworks.apps.moexplorer.misc.ContentProviderClientCompat;
import dev.dworks.apps.moexplorer.misc.CrashReportingManager;
import dev.dworks.apps.moexplorer.misc.IntentUtils;
import dev.dworks.apps.moexplorer.misc.MimePredicate;
import dev.dworks.apps.moexplorer.misc.PermissionUtil;
import dev.dworks.apps.moexplorer.misc.PinViewHelper;
import dev.dworks.apps.moexplorer.misc.PinViewHelper.PINDialogFragment;
import dev.dworks.apps.moexplorer.misc.ProviderExecutor;
import dev.dworks.apps.moexplorer.misc.RootsCache;
import dev.dworks.apps.moexplorer.misc.SAFManager;
import dev.dworks.apps.moexplorer.misc.SystemBarTintManager;
import dev.dworks.apps.moexplorer.misc.Utils;
import dev.dworks.apps.moexplorer.model.DocumentInfo;
import dev.dworks.apps.moexplorer.model.DocumentStack;
import dev.dworks.apps.moexplorer.model.DocumentsContract;
import dev.dworks.apps.moexplorer.model.DocumentsContract.Root;
import dev.dworks.apps.moexplorer.model.DurableUtils;
import dev.dworks.apps.moexplorer.model.RootInfo;
import dev.dworks.apps.moexplorer.network.NetworkConnection;
import dev.dworks.apps.moexplorer.provider.ExternalStorageProvider;
import dev.dworks.apps.moexplorer.provider.RecentsProvider;
import dev.dworks.apps.moexplorer.provider.RecentsProvider.RecentColumns;
import dev.dworks.apps.moexplorer.provider.RecentsProvider.ResumeColumns;
import dev.dworks.apps.moexplorer.setting.SettingsActivity;
import dev.dworks.apps.moexplorer.ui.DirectoryContainerView;
import dev.dworks.apps.moexplorer.ui.FloatingActionsMenu;
import dev.dworks.apps.moexplorer.ui.fabs.SimpleMenuListenerAdapter;

import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_BROWSE;
import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_CREATE;
import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_GET_CONTENT;
import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_MANAGE;
import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_OPEN;
import static dev.dworks.apps.moexplorer.BaseActivity.State.ACTION_OPEN_TREE;
import static dev.dworks.apps.moexplorer.BaseActivity.State.MODE_GRID;
import static dev.dworks.apps.moexplorer.BaseActivity.State.MODE_LIST;
import static dev.dworks.apps.moexplorer.DocumentsApplication.isTelevision;
import static dev.dworks.apps.moexplorer.fragment.DirectoryFragment.ANIM_DOWN;
import static dev.dworks.apps.moexplorer.fragment.DirectoryFragment.ANIM_NONE;
import static dev.dworks.apps.moexplorer.fragment.DirectoryFragment.ANIM_SIDE;
import static dev.dworks.apps.moexplorer.fragment.DirectoryFragment.ANIM_UP;
import static dev.dworks.apps.moexplorer.misc.AnalyticsManager.FILE_COUNT;
import static dev.dworks.apps.moexplorer.misc.AnalyticsManager.FILE_MOVE;
import static dev.dworks.apps.moexplorer.misc.AnalyticsManager.FILE_TYPE;
import static dev.dworks.apps.moexplorer.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static dev.dworks.apps.moexplorer.misc.Utils.EXTRA_ROOT;
import static dev.dworks.apps.moexplorer.provider.ExternalStorageProvider.isDownloadAuthority;
